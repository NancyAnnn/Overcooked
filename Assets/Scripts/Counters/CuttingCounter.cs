...
public class CuttingCounter : BaseCounter, IHasProgress {
    ...
    private KitchenObjectSO GetOutputFotInput(KitchenObjectSO intputKitchenObjectSO) {
        CuttingRecipeSO cuttingRecipeSO = GetCuttingRecipeSOWithInput(intputKitchenObjectSO);
